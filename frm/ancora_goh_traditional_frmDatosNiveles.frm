...
Private Sub cmdEliminar_Click()
    Dim r As Integer
    r = interface.MessageDlg("Eliminar nivel", "Eliminar un nivel significa eliminar todas las brigadas y todas las asignaturas de ese nivel, incluyendo toda la información relacionada con ellas. ¿Está seguro que desea eliminar el nivel " & (cboNiveles.ListIndex + 1) & "?", vbQuestion, "No", "Sí")
    If r = 2 Then
