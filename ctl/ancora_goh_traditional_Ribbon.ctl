...
Dim minimizado As Boolean
Dim mIndex As Integer
Dim bIndex As Integer
Dim ButtonsNow As Integer
...
Dim m_BC As Boolean
Dim zImg As MSComctlLib.ImageList
...
End Property
Public Property Let TabIndex(v As Integer)
    mIndex = v
    TabMouse_Click mIndex
End Property

Public Property Get ButtonIndex() As Integer
    ButtonIndex = bIndex
End Property
Public Property Let ButtonIndex(v As Integer)
    bIndex = v
    ButNone mIndex
End Property
...
Private Sub CatMouse_MouseMove(index As Integer, Button As Integer, Shift As Integer, x As Single, y As Single)
    ...
    ButNone
End Sub
Public Sub select_tab(index As Integer)
    TabMouse_Click index
End Sub
...
Private Sub UserControl_KeyDown(KeyCode As Integer, Shift As Integer)
    ...
    If KeyCode = 39 Or KeyCode = 37 Then
        itx = TabIndex
        If KeyCode = 39 Then
            If itx < TotalTabs - 1 Then itx = itx + 1
        End If
        If KeyCode = 37 Then
            If itx > 0 Then itx = itx - 1
        End If
    ...
    If KeyCode = 40 Or KeyCode = 38 Then
        ibx = ButtonIndex
        If KeyCode = 40 Then
            If ibx < ButtonsNow Then ibx = ibx + 1
        End If
        If KeyCode = 38 Then
            If ibx > -1 Then ibx = ibx - 1
        End If
    ...
    If KeyCode = 13 Then
        If ButtonIndex > -1 Then ButMouse_Click ButtonIndex
    End If
...
Public Sub Resize()
    UserControl_Resize
End Sub
Public Property Let ImageList(ByVal zImageList As MSComctlLib.ImageList)
    Set zImg = zImageList
End Property
